...
from unsupervised_qm9_dataset import unsupervised_qm9_dataset
...
def _parse_args():
    ...
    parser.add_argument('--dataset', '-dataset', type = str, default = 'QM9_smiles', help = 'Directory to the dataset')
    parser.add_argument('--features_fn', '-features_fn', type = str, default = 'NAME', help = 'Unsupervised features file')
...
# Dataset
train_dataset = unsupervised_qm9_dataset(directory = args.dataset, features_fn = args.features_fn, split = 'train', test_percent = 10)
test_dataset = unsupervised_qm9_dataset(directory = args.dataset, features_fn = args.features_fn, split = 'test', test_percent = 10)
